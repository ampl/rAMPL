# -*- coding: utf-8 -*-
#
# sphinx build configuration file, created by
# ReST Editor on 21-Aug-2013
#
...
latex_documents = [('index', 'sphinx.tex', u'sphinx Documentation', u'Filipe Brandao', 'manual')]
...
man_pages = [('index', 'sphinx', u'sphinx Documentation', [u'Filipe Brandão'], 1)]
