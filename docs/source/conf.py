...
copyright = u'2018-{}, AMPL Optimization Inc'.format(
...
latex_documents = [
    ('index', 'sphinx.tex', u'sphinx Documentation', u'Filipe Brandao', 'manual')]
...
man_pages = [('index', 'sphinx', u'sphinx Documentation',
              [u'Filipe Brandão'], 1)]
