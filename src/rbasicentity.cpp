...
*/
template <class T, class TW>
Rcpp::DataFrame RBasicEntity<T, TW>::getSuffixValues(const Rcpp::List &suffixes) const {
...
*/
template <class T, class TW>
SEXP RBasicEntity<T, TW>::get(const Rcpp::List &index) const {
  if(index.size() == 0) {
...
template <>
SEXP RBasicEntity<ampl::VariantRef, ampl::VariantRef>::get(const Rcpp::List &index) const {
...
*/
template <class T, class TW>
SEXP RBasicEntity<T, TW>::find(const Rcpp::List &index) const {
