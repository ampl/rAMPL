...
RCPP_MODULE(rparam_entity){
  Rcpp::class_<RBasicEntity<ampl::Variant, ampl::Variant> >("PEntity")
    ...
    //.const_method("getValues", &RBasicEntity<ampl::Variant, ampl::Variant>::getSuffixValues)
    //.const_method("getValues", &RBasicEntity<ampl::Variant, ampl::Variant>::getValues)
    //.method("setValues", &RBasicEntity<ampl::Variant, ampl::Variant>::setValues)
